...
- Patch commit: `137589c33ce5106317b496dc699dac6b6b4c98cc`
...
- Passive audits of successful streaming production requests.
- Scheduled fixed-prompt probes pinned to each managed egress node.
- Soft and hard thresholds, consecutive-error handling, minimum healthy-node protection, quarantine, and recovery.
...
The quality guard is a heuristic circuit breaker, not proof that upstream model capability changed.
